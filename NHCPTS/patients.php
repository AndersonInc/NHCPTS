...
if ($patientName != '' && $address != '' && 
  $cnic != '' && $dateBirth != '' && $phoneNumber != '' && $gender != '') {
    ...
    `address`, `cnic`, `date_of_birth`, `phone_number`, `gender`,`Age`,`Date`,`Room_No`)
VALUES('$patientName', '$address', '$cnic', '$dateBirth',
'$phoneNumber', '$gender','$age','$dateOfAdmission','$roomNumber');";
try {
...
`phone_number`, `gender`,`Age`, `Date`,`Room_No`
          ...
          <form method="post">
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                ...
                <input type="text" id="nin number" name="nin number" required="required"
                class="form-control form-control-sm rounded-0"/>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                ...
                <div class="form-group">
                  <label>Date of Admission</label>
                    ...
                    data-target-input="nearest">
                        <input type="text" class="form-control form-control-sm rounded-0 datetimepicker-input" data-target="#date_of_admission" name="dateofadmission" 
                        data-toggle="datetimepicker" autocomplete="off" />
                        <div class="input-group-append" 
                        data-target="#date_of_admission" 
                        data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                        </div>
                    </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                    ...
                    <input type="text"  name="roomnumber" required="required"
                    class="form-control form-control-sm rounded-0"/>
                  </div>
            </div>
