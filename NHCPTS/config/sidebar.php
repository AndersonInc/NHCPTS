...
<aside class="main-sidebar sidebar-dark-primary bg-black elevation-4">
    <a href="./" class="brand-link logo-switch bg-black">
      ...
      <h4 class="brand-image-xl logo-xl mb-0 text-center"><b>NHCPTS</b></h4>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item" id="mnu_doctor">
            <a href="#" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="doctor_details.php" class="nav-link" 
                id="mi_new_doctor">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Doctors</p>
                </a>
          ...
          <li class="nav-item" id="mnu_reports">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="billdetails.php" class="nav-link" 
                id="mi_bill">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Bill Details</p>
                </a>
